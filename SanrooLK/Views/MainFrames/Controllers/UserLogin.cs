...
namespace SanrooLK.Views.MainFrames.Controllers
{
    internal class UserLogin
    {
        public static async void Login_MouseDown(object sender, MouseButtonEventArgs e)
        {
            //Wait for experiance the buttonclick feedback
